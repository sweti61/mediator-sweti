---
title: "Familienkonflikt zwischen den Generationen – Mediation in Dresden"
description: "Wenn Eltern, Kinder und Geschwister nicht mehr miteinander reden: Mediation in Dresden klärt Generationenkonflikte – auch präventiv, bevor sie eskalieren. Vertraulich, strukturiert, lösungsorientiert. Kostenloses Erstgespräch."
summary: "Wenn Eltern, Geschwister und erwachsene Kinder nicht mehr miteinander reden: Mediation und moderierte Pflegegespräche in Dresden klären Generationenkonflikte – bei eskalierten Fronten und in Mehrgenerationenfamilien auch präventiv, bevor das Schweigen zur Gewohnheit wird."
categories: ["marketing"]
keywords:
  - "Generationenkonflikt Mediation Dresden"
  - "Familienkonflikt Generationen Dresden"
  - "Pflegekonflikt Geschwister Dresden"
  - "Elder Mediation Dresden"
  - "Familienmediation Dresden"
  - "Mediation pflegende Angehörige Dresden"
  - "Familienunternehmen Übergabe Konflikt Dresden"
  - "Mediator Dresden Generationen"
  - "Pflegegespräche moderieren"
  - "Mehrgenerationenfamilie"
  - "Generationenverständigung"
  - "Familienmoderation Pflege"
  - "Präventive Familiengespräche"
...
**Pflegende Angehörige und Geschwisterkonflikte**
Wer übernimmt die Pflege der Eltern? Wer springt ein, wenn es eng wird – und wer meldet sich nicht? Wenn Geschwister sich ungleich belastet fühlen oder Distanzpflege die Spannungen verschärft, braucht es einen Rahmen, in dem diese Fragen offen und fair besprochen werden können.

**Eltern und erwachsene Kinder**
Manche Konflikte zwischen Eltern und ihren erwachsenen Kindern bestehen seit Jahren – unausgesprochen, aber wirksam. Es geht um Erwartungen, die nie klar benannt wurden, um alte Verletzungen oder darum, dass sich die Rollen verändert haben, das Miteinander aber nicht. Mediation schafft den Raum, den diese Gespräche brauchen.

**Generationenwechsel im Familienunternehmen**
Übergaben scheitern selten an Zahlen. Sie scheitern daran, dass über das Entscheidende nicht gesprochen wird: über Anerkennung, Kontrolle, Vertrauen und den richtigen Zeitpunkt. Als systemischer Berater begleite ich Familien dabei, diese Themen strukturiert anzugehen – bevor sie das Unternehmen belasten.

**Entscheidungen, bevor sie zum Konflikt werden**
Manche Themen werden über Jahre umkreist, aber nie wirklich besprochen: der Umzug in eine Pflegeeinrichtung, ein gemeinsames Zusammenziehen, erbrechtliche Regelungen. Solange niemand spricht, scheint Frieden zu herrschen – tatsächlich wächst aber unausgesprochene Spannung. In moderierten Gesprächen lassen sich solche Themen vor der Eskalation bearbeiten.
...
Wir besprechen Ihre Situation vertraulich. Sie entscheiden, ob Mediation der richtige Schritt ist. Kein Druck, keine Verpflichtung.
...
Was die Beteiligten gemeinsam erarbeiten, wird schriftlich festgehalten. Eine Lösung, die wirklich trägt – weil sie von allen mitgetragen wird.
...
**Was kostet eine Mediation bei Familienkonflikten in Dresden?**
...
Mediation funktioniert nur mit den Personen, die freiwillig dabei sind. Es ist nicht nötig, dass die gesamte Familie anwesend ist – manchmal reicht es, mit den direkt Beteiligten zu beginnen.
...
**Für wen ist Mediation bei Generationenkonflikten nicht geeignet?**
...
Ja. Besonders bei Familien, deren Mitglieder in verschiedenen Städten leben, hat sich Mediation per Videogespräch bewährt. Technisch ist das gut umsetzbar – der Prozess bleibt derselbe.
...
| Sie möchten zuerst Ihre eigene Rolle klären | [Coaching in Übergängen]({{< relref "/angebote/coaching-in-uebergaengen/">}}) |
{class="UserTable"}

---

*Weitere Informationen: [Was ist Mediation?]({{< relref "/post/was-ist-mediation-mediator-dresden/">}}) · [Wie arbeite ich?]({{< relref "/post/wie-arbeitet-der-mediator-dresden/">}}) · [Startseite]({{< relref "/">}})*