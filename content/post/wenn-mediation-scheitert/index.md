+++
categories = ['Blog']
tags = ['systemisches-denken', 'fallgeschichten']

title = "Was in mir arbeitet, wenn eine Mediation scheitert"

description = "Nicht jede Mediation gelingt. Was das mit dem Mediator macht – und wie er unterscheidet zwischen methodischem Versagen und der richtigen Grenze eines Verfahrens."

summary = "Wenn eine Mediation scheitert, bleibt eine Frage zurück: Habe ich methodisch versagt – oder war das die richtige Grenze für dieses Verfahren? Dieser Artikel beschreibt, was in mir arbeitet, wenn ein Verfahren nicht gelingt, und warum diese Unterscheidung entscheidend ist."

date = 2026-08-20
read_more_copy = 'Mehr über das Scheitern in der Mediationspraxis'
url = "/post/wenn-mediation-scheitert/"
slug = "wenn-mediation-scheitert"
...
{{< smartimg
  src="wenn-mediation-scheitert.png"
  alt="Was in mir arbeitet, wenn eine Mediation scheitert – Reflexion zur Mediationspraxis"
  caption=""
...
**Erstens: Frühzeitige Auftragsklärung als Schutz des Verfahrens.**
Die Frage nach der Freiwilligkeit gehört nicht in die zweite Sitzung - sie gehört in die Auftragsklärung, bevor das Verfahren beginnt. Nicht als Formalität, sondern als echte Prüfung: Ist jede der beteiligten Personen aus eigenem Entschluss hier? Was erwartet sie von diesem Verfahren? Was ist sie bereit einzubringen?
...
- [Was Allparteilichkeit eigentlich kostet]({{< relref "/post/was-allparteilichkeit-kostet/" >}})
- [Der Moment, wo ich merke, dass die Mediation gelingt]({{< relref "/post/moment-mediation-gelingt/" >}})
- [Warum ich aufgehört habe, Lösungen anzubieten]({{< relref "/post/warum-ich-aufgehoert-habe-loesungen-anzubieten/" >}})
