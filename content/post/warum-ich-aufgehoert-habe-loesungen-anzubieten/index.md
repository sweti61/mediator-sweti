...
title = "Warum ich aufgehört habe, Lösungen anzubieten – der Übergang von direktiver zu systemischer Haltung"

description = "Nach 35 Jahren in der öffentlichen Verwaltung zur Mediation: Was es bedeutet, aufzuhören, Lösungen anzubieten – und warum das der schwierigste Teil des Übergangs war."

summary = "Direktives Denken ist effizient und in vielen Kontexten richtig. In der Mediation ist es eine Falle. Dieser Artikel beschreibt den Übergang von einer Haltung, die Probleme löst, zu einer Haltung, die Klärung ermöglicht – und was dieser Übergang kostet."

date = 2026-08-13
lastmod = 2026-08-13
read_more_copy = 'Mehr über den Übergang zur systemischen Haltung'
url = "/post/warum-ich-aufgehoert-habe-loesungen-anzubieten/"
slug = "warum-ich-aufgehoert-habe-loesungen-anzubieten"
...
{{< smartimg
  src="warum-ich-aufgehoert-habe-loesungen-anzubieten.png"
  alt="Warum ich aufgehört habe, Lösungen anzubieten – der Übergang von direktiver zu systemischer Haltung"
  caption=""
...
→ [Nach zwölf Monaten: Was Marketing nicht kann]({{< relref "/post/nach-zwoelf-monaten-was-marketing-nicht-kann/" >}})   
