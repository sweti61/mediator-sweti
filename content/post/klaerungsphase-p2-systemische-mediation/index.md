---
title: "Klärungsphase (P2) in der Mediation"
description: "Wie die Klärungsphase in der systemischen Mediation gestaltet werden kann, methodische Zugänge und die Haltung als reflexive Prozessbegleitung. Ein Beitrag für Mediator:innen, Coaches und Beratende."
summary: "Zweiter Beitrag der Reihe zu den vier Phasen der Mediation. Systemische Perspektiven auf die Klärungsphase (P2): Methoden, Interventionen und Haltung zur Konflikterhellung."
...
{{< smartimg
  ...
  alt="Klärungsphase in der systemischen Mediation"
  caption=""
...
Die zweite Phase einer Mediation wird häufig als „Herzstück" des Verfahrens beschrieben. Während die Kontaktphase (P1) vor allem der [Auftragsklärung]({{< relref "/post/systemische-auftragsklaerung" >}}) und dem Aufbau einer tragfähigen Arbeitsbeziehung dient, beginnt mit der Klärungsphase (P2) die eigentliche Auseinandersetzung mit dem Konflikt. Dabei geht es, systemisch betrachtet, nicht um Schuld oder objektive Wahrheit, sondern um eine differenzierte Exploration der Sichtweisen, Dynamiken und Kommunikationsmuster, die das Konfliktgeschehen prägen.

Dieser Beitrag gehört zur kleinen Reihe über die vier Phasen der Mediation aus systemischer Perspektive. Er richtet sich an Kolleg:innen mit systemischem Hintergrund, die ihre Praxis in der Klärungsphase methodisch schärfen möchten.
...
Zur methodischen Vertiefung: der Beitrag [Hypothesenbildung, systemische Klarheit statt vorschneller Deutung]({{< relref "/post/hypothesenbildung-systemische-beratung" >}}) beleuchtet die haltungsbezogenen Grundlagen, der Beitrag [Zyklus der Hypothesenarbeit im systemischen Denken]({{< relref "/post/zyklus-der-hypothesenarbeit-systemisches-denken" >}}) zeigt die Bewegung zwischen Bildung, Prüfung, Verwerfung und Neubildung im Prozess.
...
1. **Einladung zur Sichtweise:** Jede Partei schildert, was für sie der Kern des Problems ist, ohne Unterbrechung.
2. **Exploration und Rückfragen durch Mediator:in:** Zirkuläres Fragen, Spiegeln, Hypothesen, Visualisierung.
3. **Sichtweise der anderen Partei:** Auch hier: ungestört schildern, gefolgt von Reflexion.
4. **Verdichtung der Muster:** Was wiederholt sich? Was bleibt unerhört? Welche Tabus gibt es?
5. **Klärung gemeinsamer Anliegen:** Gibt es, trotz der Unterschiede, geteilte Werte, Absichten, Ziele?
...
Im nächsten Schritt, der [Kreationsphase (P3)]({{< relref "/post/kreationsphase-p3-systemische-mediation" >}}), geht es dann darum, aus dieser vertieften Verständigung konkrete Optionen zu entwickeln. Auch dabei wird die systemische Haltung entscheidend sein: Lösungen entstehen nicht aus Konsens, sondern aus dem klugen Umgang mit Differenz.
...
- [Auftragsklärung systemisch gestalten (P1)]({{< relref "/post/systemische-auftragsklaerung" >}}): Wie das 4-Felder-Modell, das 9-Felder-Modell und der Dreiervertrag helfen, den Prozess von Anfang an tragfähig zu gestalten.
...
Für die methodische Vertiefung zentraler Konzepte dieses Artikels:
